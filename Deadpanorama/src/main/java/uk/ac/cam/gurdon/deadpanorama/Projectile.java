...
/**
	Edited and bundled to be called from OpRender3D
...
public static final int nearestPoint=0;
public static final int brightestPoint=1;
public static final int meanValue=2;
...
private int opacity;
private int depthCueSurf;
private int depthCueInt;
private boolean interpolate;
private boolean allTimePoints;

private boolean debugMode;
private double sliceInterval; // pixels
private int transparencyLower;
private int transparencyUpper;
...
public void run(ImagePlus imp, int projectionMethod, int axisOfRotation, int initAngle, int totalAngle, int angleInc) {
	this.imp = imp;
...
private void doHyperstackProjections(ImagePlus imp) {
    ...
    buildImp.setTitle(imp.getTitle());
    buildImp.show();
}
...
private  void doRGBProjections(ImagePlus imp) {
    ...
    new ImagePlus(imp.getTitle(), stack).show();
...
private ImagePlus doProjections(ImagePlus imp) {
    ...
    ImagePlus projections = new ImagePlus(imp.getTitle(), stack2);
